 ...
 */
final class Version20240513012554 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE operation (ref INT DEFAULT NULL, numOperation INT AUTO_INCREMENT NOT NULL, typeOperation VARCHAR(255) NOT NULL, dateOperation DATETIME NOT NULL, description VARCHAR(50) NOT NULL, statusOperation TINYINT(1) NOT NULL, montantOpt DOUBLE PRECISION NOT NULL, INDEX IDX_1981A66D146F3EA3 (ref), PRIMARY KEY(numOperation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE virement_international (ref INT AUTO_INCREMENT NOT NULL, taux_echange DOUBLE PRECISION NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(ref)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
